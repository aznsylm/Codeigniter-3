...
<table border="1" width=70%>
    ...
    <tr>
        ...
        <td><?php echo $row['tgl_berita'];echo' ';echo $row['jam_berita']; ?></td>
        ...
        <td>
            ...
            ?>
            <a href="<?php echo site_url('berita/edit/'.$row['id_berita']) ?>" title="Ubah"><button class="">Ubah</button></a>
            <a href="<?php echo site_url('berita/delete/'.$row['id_berita']) ?>" title="Delete" onclick="javascript: 
